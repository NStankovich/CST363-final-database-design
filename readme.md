...
The database for this project has been migrated to Heroku. The Spring Boot controller is hosted on Replit. However, it will take some time to start up on Replit (An error message will display until it does). Eventually, I will migrate it off of Replit, but until then, I recommend running this project locally if possible.
